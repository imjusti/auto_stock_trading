...
result = lib.getCaseFromGSpread(worksheet, str_today, config['google_spreadsheet_case1_colname'], config['google_spreadsheet_case7_colname'])
if result is None:
...
# 오늘의 방향 결정
dirToday, sellType = lib.decideStrategy(case1, case7, case8)
...
# 텔레그램으로 오늘의 작전 전송
msg_telegram = lib.makeMessage(str_today, dirToday, sellType, case1, case7, case8, worksheet)
